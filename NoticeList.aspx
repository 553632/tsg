<%@ Page Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="qjbopac.NoticeList" Title="公告信息" %>
...
function ChanagePage(page)
{
    ...
    //alert(pagesize);
    var res = qjbopac.NoticeList.ShowBookList(page,pagesize,'l_type=13');
