<%@ Page Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="Introduction.aspx.cs" Inherits="qjbopac.Introduction" Title="本馆概况" %>
...
function ChanagePage(page)
{
    ...
    //alert(pagesize);
    var res = qjbopac.Introduction.ShowBookList(page,pagesize,'l_type=11');
